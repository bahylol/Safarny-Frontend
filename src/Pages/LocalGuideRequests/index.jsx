...
const columns = [
    ...
    { id: 'biography', label: 'Biography', minWidth: 100 },
    { id: 'national_id', label: 'National Id', minWidth: 100 },
...
function LocalGuideRequests() {
    ...
    for (let i = 0; i < rowsData.length; i++) {
        const { admin_id, country, city, biography, national_id, request_email, resume, status } = rowsData[i];
        const dataObject = createData(admin_id, country, city, biography, national_id, request_email, resume, status);
        rows.push(dataObject);
    }

    function createData(admin_id, country, city, biography, national_id, request_email, resume, status) {
        return { admin_id, country, city, biography, national_id, request_email, resume, status };
    }
    ...
    const getLocalGuideRequests = async () => {
        await fetch(`${process.env.REACT_APP_BACKEND_URL}/getRequests/localGuide`, {
            method: 'GET',
            headers: {
